...
| GenerateBillCommand_WhenInputIsValid_ThenSavesInvoice | Validar fluxo completo de geração de fatura | GenerateBillCommandHandler.Handle | Command válido | GenerateBillResult com Id | Y |
